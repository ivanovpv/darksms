...
package ru.ivanovpv.gorets.psm.mms.transaction;
...
import ru.ivanovpv.gorets.psm.mms.PhoneConstants;
...
public class TransactionSettings {
    ...
    public TransactionSettings(Context context, String apnName) {
        ...
        Cursor cursor=context.getContentResolver().query(Telephony.Carriers.CONTENT_URI, APN_PROJECTION, selection, selectionArgs, null);
        ...
        try {
            while (cursor.moveToNext() && TextUtils.isEmpty(mServiceCenter)) {
                ...
                if (isValidApnType(cursor.getString(COLUMN_TYPE), PhoneConstants.APN_TYPE_MMS)) {
                    ...
                    mServiceCenter = trimV4AddrZeros(mmsc.trim());
