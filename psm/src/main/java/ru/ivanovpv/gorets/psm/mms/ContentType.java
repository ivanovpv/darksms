...
public class ContentType {
    public static final String MMS_MESSAGE_STARTER   = "application/vnd.wap.";
    public static final String MMS_MESSAGE           = MMS_MESSAGE_STARTER+"mms-message";
    // The phony content type for generic PDUs (e.g. ReadOrig.ind,
    // Notification.ind, Delivery.ind).
    public static final String MMS_GENERIC           = MMS_MESSAGE_STARTER+"mms-generic";
    public static final String MULTIPART_MIXED       = MMS_MESSAGE_STARTER+"multipart.mixed";
    public static final String MULTIPART_RELATED     = MMS_MESSAGE_STARTER+"multipart.related";
    public static final String MULTIPART_ALTERNATIVE = MMS_MESSAGE_STARTER+"multipart.alternative";
    ...
    public static final String APP_WAP_XHTML     = MMS_MESSAGE_STARTER+"xhtml+xml";
    ...
    /**
     * modified by ivanovpv
     * @param contentType
     * @return
     */
    public static boolean isAudioType(String contentType) {
        return (null != contentType) && (contentType.startsWith("audio/") || contentType.startsWith(ContentType.AUDIO_OGG));
    }
     ...
     * @return
     */
    public static boolean isSmilType(String contentType) {
        return (null != contentType) && (contentType.startsWith(APP_SMIL));
    }
