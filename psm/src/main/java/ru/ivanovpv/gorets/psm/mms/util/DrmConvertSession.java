 ...
 *
 */
package ru.ivanovpv.gorets.psm.mms.util;
...
public class DrmConvertSession {
    ...
    /**
     * copied from android.provider.Downloads class
     * by ivanovpv
     */
    public static final int DOWNLOADS_STATUS_UNKNOWN_ERROR = 491;
    public static final int DOWNLOADS_STATUS_NOT_ACCEPTABLE = 406;
    public static final int DOWNLOADS_STATUS_SUCCESS = 200;
    public static final int DOWNLOADS_STATUS_FILE_ERROR = 492;
    ...
    public int close(String filename) {
        DrmConvertedStatus convertedStatus = null;
        int result = DOWNLOADS_STATUS_UNKNOWN_ERROR;
        if (mDrmClient != null && mConvertSessionId >= 0) {
            try {
                ...
                if (convertedStatus == null ||
                        convertedStatus.statusCode != DrmConvertedStatus.STATUS_OK ||
                        convertedStatus.convertedData == null) {
                    result = DOWNLOADS_STATUS_NOT_ACCEPTABLE;
                } else {
                    ...
                    try {
                        ...
                        result = DOWNLOADS_STATUS_SUCCESS;
                    } catch (FileNotFoundException e) {
                        result = DOWNLOADS_STATUS_FILE_ERROR;
