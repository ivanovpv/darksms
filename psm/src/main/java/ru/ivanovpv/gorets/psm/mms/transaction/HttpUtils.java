...
import ru.ivanovpv.gorets.psm.mms.MmsConfig;
...
public class HttpUtils {
     ...
     */
    public static byte[] httpConnection(Context context, long token, String url, byte[] pdu, int method, boolean isProxySet,
