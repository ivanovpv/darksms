 ...
 *   $URL: https://subversion.assembla.com/svn/ivanovpv/trunk/src/ru/ivanovpv/gorets/psm/cipher/R250RNG.java $
 */
...
public final class R250RNG extends Randomer
{
    ...
    public byte[] getBytes(int size)
    {
        ...
        final int MAX_UNSIGNED_BYTE=256;
        final int MAX_SIGNED_BYTE=128;
        for(int i=0; i < buffer.length; i++)
        {
            int k=this.getInt(MAX_UNSIGNED_BYTE);
            buffer[i]=(byte) (k - MAX_SIGNED_BYTE);
        }
        return buffer;
    }
