 ...
 *   $URL: https://subversion.assembla.com/svn/ivanovpv/trunk/src/com/viewpagerindicator/TitlePageIndicator.java $
 */
...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    public void setViewPager(ViewPager view) {
        ...
        mViewPager = view;
        mViewPager.setOnPageChangeListener(this);       // TODO GORETS HACK
        invalidate();
    }
...
/*
        ...
        PSMActivity.finder.setText("");
        PSMActivity.finder.setVisibility(View.INVISIBLE);
        PSMActivity.searchActive.setChecked(false);
        switch (position){
            case 0:
                break;
            case 1:
                PSMActivity.searchActive.setVisibility(View.VISIBLE);
                break;
            case 2:
                PSMActivity.searchActive.setChecked(false);
                PSMActivity.searchActive.setVisibility(View.GONE);
                PSMActivity.speechButton.setVisibility(View.GONE);
                break;
        }
*/
